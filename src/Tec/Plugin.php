...
class Plugin extends Service_Provider {
	...
	public function register() {
		...
		$this->container->singleton( 'extension.ticketuserlimit', $this );
		$this->container->singleton( 'extension.ticketuserlimit.plugin', $this );
	...
	protected function register_plugin_dependencies() {
		...
		$this->container->singleton( 'extension.ticketuserlimit', $plugin_register );
	}
	 ...
	 * @return string
     *
	 * @see \Tribe\Extensions\Ticket_User_Limit\Settings::set_options_prefix()
	 *
	 * TODO: Remove if not using settings
	 */
	private function get_options_prefix() {
		return (string) str_replace( '-', '_', 'tec-labs-ticketuserlimit' );
	}
